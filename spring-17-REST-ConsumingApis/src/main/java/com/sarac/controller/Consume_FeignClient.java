...
import com.sarac.client.EmployeeClient;
import com.sarac.client.UserClient;
...
public class Consume_FeignClient {
    ...
    public ResponseEntity<ResponseWrapper>getEmployee(){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Employee retrieve",employeeClient.getEmployee("6298ebfecd0551211fce37a6")));
    }
